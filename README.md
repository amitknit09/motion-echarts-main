...
If you are migrating from `motion-echarts` ≤ 5, you should read the _[Migration to v6](#migration-to-v6)_ section before you update to v6.

Not ready yet? Read documentation for older versions [here →](https://github.com/ecomfe/motion-echarts/tree/5.x)
...
```bash
$ npm install echarts motion-echarts
```

To make `motion-echarts` work for *Vue 2* (<2.7.0), you need to have `@vue/composition-api` installed:
...
import ECharts from 'motion-echarts'
...
<details>
<summary>Vue 3 <a href="https://stackblitz.com/edit/motion-echarts-vue-3?file=src%2FApp.vue">Demo →</a></summary>
...
import VChart, { THEME_KEY } from "motion-echarts";
...
<details>
<summary>Vue 2 <a href="https://stackblitz.com/edit/motion-echarts-vue-2?file=src%2FApp.vue">Demo →</a></summary>
...
<details>
<summary>Vue 3 <a href="https://stackblitz.com/edit/motion-echarts-vue-3-global?file=index.html">Demo →</a></summary>

<!-- vue3Scripts:start -->
```html
<script src="https://cdn.jsdelivr.net/npm/vue@3.2.37"></script>
<script src="https://cdn.jsdelivr.net/npm/echarts@5.3.3"></script>
<script src="https://cdn.jsdelivr.net/npm/motion-echarts@6.2.3"></script>
```
<!-- vue3Scripts:end -->
...
<details>
<summary>Vue 2 <a href="https://stackblitz.com/edit/motion-echarts-vue-2-global?file=index.html">Demo →</a></summary>
...
See more examples [here](https://github.com/ecomfe/motion-echarts/tree/main/src/demo).
...
motion-echarts provides provide/inject API for `theme`, `init-options`, `update-options` and `loading-options` to help configuring contextual options. eg. for `init-options` you can use the provide API like this:

<details>
<summary>Vue 3</summary>

```js
import { INIT_OPTIONS_KEY } from 'motion-echarts'
...
motion-echarts support the following events:
...
The following breaking changes are introduced in `motion-echarts@6`:

### Vue 2 support

- If you are using version prior to `vue@2.7.0`, `@vue/composition-api` is required to be installed to use motion-echarts with Vue 2.
