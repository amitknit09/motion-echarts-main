...
function switchVersion(version) {
  ...
  console.log(`[motion-echarts] Switched to Vue ${version} environment.`);
}
...
if (!Vue || typeof Vue.version !== "string") {
  console.warn(
    '[motion-echarts] Vue is not found. Please run "npm install vue" to install.'
  );
  ...
  console.warn(`[motion-echarts] Vue version v${Vue.version} is not supported.`);
}
